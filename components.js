...
function renderTaxComplianceView(state) {
    return `
        <div class="grid-stats" style="margin-bottom:32px;">
            <div class="card stat-card">
                <span class="stat-label">Next Tax Filing Deadline</span>
                <span class="stat-value" style="font-size: 20px;">July 31, 2026</span>
                <span class="stat-trend" style="color:var(--text-secondary)">Quarter 2 Form 941 Filing</span>
            </div>
            <div class="card stat-card">
                <span class="stat-label">Accrued Q2 FICA (Fed Deposit)</span>
                <span class="stat-value" id="complianceAccruedFica">$0.00</span>
                <span class="stat-trend up">Calculated in real-time</span>
            </div>
            <div class="card stat-card">
                <span class="stat-label">FUTA Liability (YTD)</span>
                <span class="stat-value" id="complianceFutaLiability">$0.00</span>
                <span class="badge badge-success" style="align-self:flex-start;">Credited at 5.4%</span>
            </div>
        </div>

        <div class="dashboard-grid">
            <div class="card">
                <div class="section-title">IRS Tax Forms & Filings</div>
                <p style="font-size: 13px; color: var(--text-secondary); margin-bottom: 20px;">
                    Review and generate pre-populated IRS federal payroll tax forms. Calculations are pulled from processed payroll runs.
                </p>
                <div style="display:flex; flex-direction:column; gap:16px;">
                    <div style="display:flex; justify-content:space-between; align-items:center; border: 1px solid var(--border-color); padding: 16px; border-radius: var(--radius-md);">
                        <div>
                            <div style="font-weight:600;">Form 941 (Quarterly Federal Return)</div>
                            <div style="font-size:12px; color:var(--text-tertiary);">Report wages, tips, FIT, and FICA deposits.</div>
                        </div>
                        <button class="btn btn-outline" onclick="AeroApp.simulateForm941()">View Form 941</button>
                    </div>
                    
                    <div style="display:flex; justify-content:space-between; align-items:center; border: 1px solid var(--border-color); padding: 16px; border-radius: var(--radius-md);">
                        <div>
                            <div style="font-weight:600;">W-2 Summary Statements</div>
                            <div style="font-size:12px; color:var(--text-tertiary);">Generate Wage and Tax Statements for W-2 Employees.</div>
                        </div>
                        <div style="display:flex; gap:8px;">
                            <select class="form-control" style="width: 140px; padding: 4px 8px; font-size:12px;" id="w2EmployeeSelect">
                                <!-- Filled in app.js -->
                            </select>
                            <button class="btn btn-outline" onclick="AeroApp.generateW2()">Generate W-2</button>
                        </div>
                    </div>
                    
                    <div style="display:flex; justify-content:space-between; align-items:center; border: 1px solid var(--border-color); padding: 16px; border-radius: var(--radius-md);">
                        <div>
                            <div style="font-weight:600;">1099-NEC Independent Contractor Files</div>
                            <div style="font-size:12px; color:var(--text-tertiary);">Non-employee compensation records for independent contractors.</div>
                        </div>
                        <div style="display:flex; gap:8px;">
                            <select class="form-control" style="width: 140px; padding: 4px 8px; font-size:12px;" id="necContractorSelect">
                                <!-- Filled in app.js -->
                            </select>
                            <button class="btn btn-outline" onclick="AeroApp.generate1099()">Generate 1099</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="section-title">Compliance Reminders</div>
                <div style="display:flex; flex-direction:column; gap:16px;">
                    <div style="display:flex; gap:12px;">
                        <div style="width:8px; height:8px; border-radius:var(--radius-full); background-color:var(--danger); margin-top: 6px;"></div>
                        <div>
                            <div style="font-size:13px; font-weight:600;">Quarterly Form 941 Submission</div>
                            <div style="font-size:11px; color:var(--text-secondary);">Deadline: July 31, 2026. Automated e-file pending.</div>
                        </div>
                    </div>
                    
                    <div style="display:flex; gap:12px;">
                        <div style="width:8px; height:8px; border-radius:var(--radius-full); background-color:var(--warning); margin-top: 6px;"></div>
                        <div>
                            <div style="font-size:13px; font-weight:600;">State Unemployment Deposit</div>
                            <div style="font-size:11px; color:var(--text-secondary);">CA SUTA & NY SUTA due within 30 days of quarter close.</div>
                        </div>
                    </div>
                    
                    <div style="display:flex; gap:12px;">
                        <div style="width:8px; height:8px; border-radius:var(--radius-full); background-color:var(--success); margin-top: 6px;"></div>
                        <div>
                            <div style="font-size:13px; font-weight:600;">New Hire Reporting (CA/NY)</div>
                            <div style="font-size:11px; color:var(--text-secondary);">Completed. AeroPay automatically filed new-hire reports.</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <main class="landing-hero-container">
                ...
                <div class="login-card">
                    <div class="login-header-text">
                        ...
                        <p class="login-subtitle">Authenticate to view payroll data</p>
                    </div>

                    <div class="login-tabs">
                        <button class="login-tab-btn active" id="btnTabCompany" onclick="AeroApp.switchLoginTab('company')">Company Account</button>
                        <button class="login-tab-btn" id="btnTabEmployee" onclick="AeroApp.switchLoginTab('employee')">Employee Portal</button>
                    </div>

                    <!-- Company Admin Form -->
                    <form id="formCompanyLogin" class="login-form-container active" onsubmit="AeroApp.handleLogin(event, 'company')">
                        <div class="form-group">
                            <label for="companyEmailInput" style="font-weight:600; font-size:13px; color:var(--text-secondary);">Corporate Email</label>
                            <input type="email" class="form-control" id="companyEmailInput" value="admin@zenith.com" required>
                        </div>
                        <div class="form-group">
                            <label for="companyPasswordInput" style="font-weight:600; font-size:13px; color:var(--text-secondary);">Password</label>
                            <input type="password" class="form-control" id="companyPasswordInput" value="admin123" required>
                        </div>
                        <button type="submit" class="btn btn-primary" style="width:100%; height:44px; margin-top:8px;">Sign In to Dashboard</button>
                        
                        <div class="login-helper">
                            <strong>Demo Credentials:</strong><br/>
                            Click to fill: <code onclick="document.getElementById('companyEmailInput').value='admin@zenith.com'; document.getElementById('companyPasswordInput').value='admin123';">admin@zenith.com / admin123</code>
                        </div>
                    </form>
                    ...
                    <form id="formEmployeeLogin" class="login-form-container" onsubmit="AeroApp.handleLogin(event, 'employee')">
                        <div class="form-group">
                            <label for="employeeEmailInput" style="font-weight:600; font-size:13px; color:var(--text-secondary);">Email Address</label>
                            <input type="email" class="form-control" id="employeeEmailInput" value="sarah.j@company.com" required>
                        </div>
                        <div class="form-group">
                            <label for="employeePINInput" style="font-weight:600; font-size:13px; color:var(--text-secondary);">Security PIN</label>
                            <input type="password" class="form-control" id="employeePINInput" value="12345" required placeholder="PIN (5 digits)">
                        </div>
                        <button type="submit" class="btn btn-primary" style="width:100%; height:44px; margin-top:8px;">Sign In to Employee Portal</button>

                        <div class="login-helper">
                            <strong>Demo Accounts:</strong><br/>
                            W-2 Salaried: <code onclick="document.getElementById('employeeEmailInput').value='sarah.j@company.com'; document.getElementById('employeePINInput').value='12345';">sarah.j@company.com</code><br/>
                            W-2 Hourly: <code onclick="document.getElementById('employeeEmailInput').value='e.rostova@company.com'; document.getElementById('employeePINInput').value='12345';">e.rostova@company.com</code><br/>
                            1099 Contractor: <code onclick="document.getElementById('employeeEmailInput').value='m.brody@company.com'; document.getElementById('employeePINInput').value='12345';">m.brody@company.com</code>
                        </div>
                    </form>
                </div>
            </main>
